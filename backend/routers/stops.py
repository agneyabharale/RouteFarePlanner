...
from backend.models.requests import StopSearchRequest
from backend.models.response import StopSearchResponse, StopResult
    ...
    for node_id, node_data in nodes.items():
        ...
        if query in node_id.lower() or query in name:
            results.append(StopResult(
                ...
                lng         = node_data.get("lng", 0.0),   # Fix: was "lon", nodes.json uses "lng"
